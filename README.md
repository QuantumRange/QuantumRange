...
You can reach me on Discord: `QuantumRange#0354` *(`@quantumrange`)*, but I would prefer [Matrix](https://matrix.org/) **`@quantumrange:matrix.org`** or *`@quantumrange:matrix.qhive.de`*.
